...
def parse_args(training=False):
    ...
    # model config
    parser.add_argument("--config", help="model config file path",default='configs/opensora/inference/16x256x256.py',required=False)

    parser.add_argument("--seed", default=42, type=int, help="generation seed")
    parser.add_argument("--ckpt-path", type=str, help="path to model ckpt; will overwrite cfg.ckpt_path if specified",default='')
