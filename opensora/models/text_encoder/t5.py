...
class T5Embedder:
    ...
    def __init__(
        ...
        *,
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('./t5_token')#加载项目根目录下的.
        # import transformers.models.t5.configuration_t5 as ttt
        from transformers.models.t5.configuration_t5 import T5Config
        bbbb=T5Config.from_pretrained('./t5_token/config.json')
        self.model = T5EncoderModel(bbbb).eval()
...
class T5Encoder:
    ...
    def encode(self, text):
        ...
        caption_embs = caption_embs[:, None] # 每一个编码dimension是4096, 第二个维度拓展一维.
